const wand = document.getElementById("wand"),
  frame = document.querySelectorAll(".pic");
...
const revealImages = (mouseX) => {
  for (const pic of frame) {
    const dimensions = pic.getBoundingClientRect(),
    ...
    pic.style.setProperty("--opacity", opacity);
    pic.style.setProperty("--blur", blur);
  }
};
